...
from survey.views import check_limesurvey_access, get_questionnaire_language
...
PATIENT_FIELDS = [
    ...
    {
        "field": "socialdemographicdata__natural_of",
        "header": "natural_of",
        "description": _("Natural of"),
        "json_data_type": "string",
    },
    {
        "field": "socialdemographicdata__schooling__name",
        "header": "schooling",
        "description": _("Schooling"),
        "json_data_type": "string",
    },
    {
        "field": "socialdemographicdata__patient_schooling__name",
        "header": "patient_schooling",
        "description": _("Schooling of the patient"),
        "json_data_type": "string",
    },
    {
        "field": "socialdemographicdata__profession",
        "header": "profession",
        "description": _("Profession"),
        "json_data_type": "string",
    },
    {
        "field": "socialdemographicdata__social_class",
        "header": "social_class",
        "description": _("Calculated social class"),
        "json_data_type": "string",
    },
    {
        "field": "socialdemographicdata__occupation",
        "header": "occupation",
        "description": _("Occupation"),
        "json_data_type": "string",
    },
    {
        "field": "socialdemographicdata__benefit_government",
        "header": "benefit_government",
        "description": _(
            "Do you receive some benefit from the municipal level, state or federal government?"
        ),
        "json_data_type": "boolean",
    },
    {
        "field": "socialdemographicdata__religion__name",
        "header": "religion",
        "description": _("Religion"),
        "json_data_type": "string",
    },
    {
        "field": "socialdemographicdata__flesh_tone__name",
        "header": "flesh_tone",
        "description": _("Flesh tone"),
        "json_data_type": "string",
    },
    {
        "field": "socialdemographicdata__citizenship",
        "header": "citizenship",
        "description": _("Citizenship"),
        "json_data_type": "string",
    },
    {
        "field": "socialdemographicdata__payment__name",
        "header": "payment",
        "description": _("What form of payment of the treatment performed"),
        "json_data_type": "string",
    },
    {
        "field": "socialhistorydata__smoker",
        "header": "smoker",
        "description": _("Smoker"),
        "json_data_type": "boolean",
    },
    {
        "field": "socialhistorydata__amount_cigarettes__name",
        "header": "amount_cigarettes",
        "description": _("Cigarretes/Day"),
        "json_data_type": "string",
    },
    {
        "field": "socialhistorydata__ex_smoker",
        "header": "former_smoker",
        "description": _("Former smoker"),
        "json_data_type": "boolean",
    },
    {
        "field": "socialhistorydata__alcoholic",
        "header": "alcoholic",
        "description": _("Alcoholic"),
        "json_data_type": "boolean",
    },
    {
        "field": "socialhistorydata__alcohol_frequency__name",
        "header": "alcohol_frequency",
        "description": _("Frequency"),
        "json_data_type": "string",
    },
    {
        "field": "socialhistorydata__alcohol_period__name",
        "header": "alcohol_period",
        "description": _("Period"),
        "json_data_type": "string",
    },
    {
        "field": "socialhistorydata__drugs",
        "header": "drugs",
        "description": _("Drugs"),
        "json_data_type": "string",
    },
...
DIAGNOSIS_FIELDS = [
    {
        "field": "medicalrecorddata__diagnosis__date",
        "header": "diagnosis_date",
        "description": _("Date"),
        "json_data_type": "date",
    },
    {
        "field": "medicalrecorddata__diagnosis__description",
        "header": "diagnosis_description",
        "description": _("Observation"),
        "json_data_type": "string",
    },
    {
        "field": "medicalrecorddata__diagnosis__classification_of_diseases__code",
        "header": "classification_of_diseases_code",
    ...
    },
    {
        ...
        "description": _("Disease Description"),
        "json_data_type": "string",
    },
    {
...
def abbreviated_data(data_to_abbreviate, heading_type="abbreviated"):
    if (
        ...
        and len(data_to_abbreviate) > ABBREVIATED_FIELDS_LENGTH
    ):
...
def update_fields(list_, heading_type, fields):
    ...
    list_.insert(
        ...
        [
            ...
            abbreviated_data(participant_code["header"], heading_type),
        ],
    )
...
def export_create(
    ...
    export_id,
    input_filename,
    template_name="export/export_data.html",
    ...
    try:
        ...
        input_export_file = path.join(
            "export", str(request.user.id), str(export_instance.id), str(input_filename)
        )
        ...
        if export.get_input_data("participants")["output_list"]:
            ...
            export_rows_participants = export.process_participant_data(
                participants_input_data,
                participants_list,
                language_code,
                participants_plugin,
            )
            export.get_input_data("participants")[
                "data_list"
        ...
        if "group_selected_list" in request.session:
            ...
            export.include_group_data(
                request.session["group_selected_list"], participants_plugin
            )
            ...
            if export.get_input_data("questionnaires"):
                ...
                if export.get_input_data("export_per_participant"):
                    error_msg = (
                        export.process_per_participant_per_entrance_questionnaire(
                            request.POST.get("headings")
                        )
                    )
                    if error_msg != "":
            ...
            error_msg = export.process_per_participant_per_experiment(
                request.POST.get("headings"),
                per_experiment_plugin=per_experiment_plugin,
            )
            if error_msg != "":
                messages.error(request, error_msg)
                return render(request, template_name)
            ...
            if export.get_input_data("questionnaires"):
                ...
                error_msg = export.process_per_questionnaire(
                    request.POST.get("headings"), participants_plugin
                )
                ...
                error_msg = export.process_per_participant(
                    request.POST.get("headings"),
                    participants_plugin if participants_plugin else None,
                )
                if error_msg != "":
                    messages.error(request, error_msg)
                    return render(request, template_name)
...
def export_view(request, template_name="export/export_data.html"):
    ...
    if request.method == "POST":
        ...
        if (
            "patient_selected" not in request.POST
            or request.POST.get("patient_selected") is None
        ):
        ...
        if request.POST.getlist("to_experiment[]"):
            experiment_questionnaires_selected_list = request.POST.getlist(
                "to_experiment[]"
            )
            previous_questionnaire_id = -1
            output_list = []
        ...
        selected_data_available = (
            ...
            or len(experiment_questionnaires_selected_list)
            or len(participant_fields_selected)
            or len(diagnosis_selected_list)
        )
        ...
        if selected_data_available:
            if export_form.is_valid():
                ...
                component_list["per_eeg_raw_data"] = export_form.cleaned_data[
                    "per_eeg_raw_data"
                ]
                component_list["per_eeg_nwb_data"] = export_form.cleaned_data[
                    "per_eeg_nwb_data"
                ]
                component_list["per_emg_data"] = export_form.cleaned_data[
                    "per_emg_data"
                ]
                component_list["per_tms_data"] = export_form.cleaned_data[
                    "per_tms_data"
                ]
                component_list["per_additional_data"] = export_form.cleaned_data[
                    "per_additional_data"
                ]
                component_list["per_goalkeeper_game_data"] = export_form.cleaned_data[
                    "per_goalkeeper_game_data"
                ]
                component_list["per_stimulus_data"] = export_form.cleaned_data[
                    "per_stimulus_data"
                ]
    ...
    if surveys:
        ...
        for patient_questionnaire_response in patient_questionnaire_response_list:
            ...
            if lime_survey_id not in surveys_id_list:
                ...
                if completed is not None and completed != "N" and completed != "":
                    ...
                    surveys_with_ev_list.append(
                        get_object_or_404(
                            Survey, pk=patient_questionnaire_response.survey_id
                        )
                    )
        ...
        if surveys_with_ev_list:
            ...
            for questionnaire in questionnaires_fields_list:
                questionnaire["selected_counter"] = questionnaire_ids.count(
                    questionnaire["sid"]
                )
    ...
    if (
        ...
        and questionnaires_experiment_list_final
    ):
        ...
        for questionnaire in questionnaires_experiment_fields_list:
            questionnaire["selected_field_counter"] = questionnaire_ids.count(
                questionnaire["sid"]
            )
            questionnaire["index"] = index
            index += 1
            for output_list in questionnaire["output_list"]:
                if (
                    questionnaire["sid"],
                    output_list["field"],
                ) in selected_ev_quest_experiments:
                    output_list["selected"] = True
    ...
    if group.experimental_protocol:
        for path_experiment in create_list_of_trees(
            ...
            if experiment_questionnaire_response_list:
                ...
                if (
                    lime_survey_id
                    not in experiment_questionnaire_response_dict[group_id]
                ):
                    experiment_questionnaire_response_dict[group_id][
                        lime_survey_id
                    ] = []
...
def get_questionnaire_experiment_header(
    ...
    if not isinstance(responses_string, dict):
        ...
        questionnaire_questions_heading_type = QuestionnaireUtils.responses_to_csv(
        ...
        questionnaire_header = list(
            zip(questionnaire_questions_heading_type[0], questionnaire_questions[0])
        )
...
def update_questionnaire_list(
    questionnaire_list, heading_type, experiment_questionnaire, current_language="pt-BR"
):
    ...
    for questionnaire in questionnaire_list:
        ...
        if experiment_questionnaire:
            ...
            token_id = experiment_questionnaire_response_dict[group_id][
                questionnaire_id
            ][0].token_id
            ...
            questionnaire_list_updated.append(
                [index, group_id, questionnaire_id, title, questionnaire_field_header]
            )
...
def get_questionnaire_header(
    ...
    if questionnaire_response_list:
        ...
        if not isinstance(responses_string, dict):
            questionnaire_questions = QuestionnaireUtils.responses_to_csv(
                responses_string
            )
            responses_heading_type = questionnaire_lime_survey.get_header_response(
                questionnaire_id, language_new, token, heading_type=heading_type
...
def get_questionnaire_experiment_fields(
    questionnaire_code_list, language_current="pt-BR"
):
    ...
    for questionnaire in questionnaire_code_list:
        ...
        language_new = get_questionnaire_language(
            questionnaire_lime_survey, questionnaire_id, language_current
        )
        responses_string = questionnaire_lime_survey.get_header_response(
            questionnaire_id, language_new, token
        )
        questionnaire_title = questionnaire_lime_survey.get_survey_title(
            questionnaire_id, language_new
        )
    ...
    if request.method == "POST":
        if request.POST["action"] == "next-step-1":
            ...
            if request.POST["type_of_selection_radio"] == "selected":
                ...
                return render(
                    request, "export/show_selected_participants.html", context
                )
...
def search_locations(request):
    if request.accepts("application/json"):
        ...
        if search_text:
            location_list = (
                Patient.objects.filter(city__icontains=search_text)
    ...
    if request.accepts("application/json"):
        ...
        if search_text:
            classification_of_diseases_list = (
                ClassificationOfDiseases.objects.filter(diagnosis__isnull=False)
                .filter(
            ...
            for classification_of_diseases in classification_of_diseases_list:
                label = (
                    classification_of_diseases.code
                    + " - "
