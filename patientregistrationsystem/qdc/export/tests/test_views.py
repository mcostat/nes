...
class ExportQuestionnaireTest(ExportTestCase):
    ...
    def _set_all_questions():
        return [
            (
                {
                    ...
                    "full": _("Acquisition date:"),
                    "abbreviated": _("Acquisition date:"),
                },
                "D",
                "datetime",
                "%Y-%m-%d %H:%M:%S",
            ...
            (
                {
                    "code": "funfpunktewahl",
                    "full": _("Fünf Punkte Wahl"),
                    "abbreviated": _("Fünf Punkte Wahl"),
                },
                "5",
                "string",
                "default",
            ...
            (
                {
                    "code": "dropdownliste",
                    "full": _("Dropdown Liste"),
                    "abbreviated": _("Dropdown Liste"),
                },
                "!",
                "string",
                "default",
            ...
            (
                {
                    "code": "listemitkommentar",
                    "full": _("Liste mit Kommentar"),
                    "abbreviated": _("Liste mit Komme.."),
                },
                "O",
                "string",
                "default",
            ...
            (
                {
                    "code": "listemitkommentar[comment]",
                    "full": _("Liste mit Kommentar [Comment]"),
            ...
            (
                {
                    "code": "arrayzehnpunktewahl[SQ001]",
                    "full": _("Array (Zehn Punkte Wahl) [Unterfrage eins]"),
            ...
            (
                {
                    "code": "arrayzehnpunktewahl[SQ002]",
                    "full": _("Array (Zehn Punkte Wahl) [Unterfrage zwei]"),
            ...
            (
                {
                    "code": "arrayfunfpunktewahl[SQ001]",
                    "full": _("Array (Fünf Punkte Wahl) [Unterfrage eins]"),
            ...
            (
                {
                    "code": "arrayfunfpunktewahl[SQ002]",
                    "full": _("Array (Fünf Punkte Wahl) [Unterfrage zwei]"),
            ...
            (
                {
                    "code": "arrayerhohengleichev[SQ001]",
                    "full": _("Array (Erhöhen/Gleiche/Verringern) [Unterfrage eins]"),
            ...
            (
                {
                    "code": "arrayerhohengleichev[SQ002]",
                    "full": _("Array (Erhöhen/Gleiche/Verringern) [Unterfrage zwei]"),
            ...
            (
                {
                    "code": "arrayjaneinunsicher[SQ001]",
                    "full": _("Array (Ja/Nein/Unsicher) [Unterfrage eins]"),
            ...
            (
                {
                    "code": "arrayjaneinunsicher[SQ002]",
                    "full": _("Array (Ja/Nein/Unsicher) [Unterfrage zwei]"),
            ...
            (
                {
                    "code": "arrayvonspalte[SQ001]",
                    "full": _("Array von Spalte [Unterfrage eins]"),
            ...
            (
                {
                    "code": "arrayvonspalte[SQ002]",
                    "full": _("Array von Spalte [Unterfrage zwei]"),
            ...
            (
                {
                    "code": "arraydualeskala[SQ001][1]",
                    "full": _("Array Duale Skala [Unterfrage eins][Scale 1]"),
            ...
            (
                {
                    "code": "arraydualeskala[SQ001][2]",
                    "full": _("Array Duale Skala [Unterfrage eins][Scale 2]"),
            ...
            (
                {
                    "code": "arraydualeskala[SQ002][1]",
                    "full": _("Array Duale Skala [Unterfrage zwei][Scale 1]"),
            ...
            (
                {
                    "code": "arraydualeskala[SQ002][2]",
                    "full": _("Array Duale Skala [Unterfrage zwei][Scale 2]"),
            ...
            (
                {
                    "code": "dateiupload[filecount]",
                    "full": _("filecount - Datei-Upload"),
            ...
            (
                {
                    "code": "sprachumschaltung",
                    "full": _("Sprachumschaltung"),
                    "abbreviated": _("Sprachumschaltung"),
                },
                "I",
                "string",
                "default",
            ...
            (
                {
                    "code": "mehrfachenumerischee[SQ001]",
                    "full": _("Mehrfache numerische Eingabe [Unterfrage eins]"),
            ...
            (
                {
                    "code": "mehrfachenumerischee[SQ002]",
                    "full": _("Mehrfache numerische Eingabe [Unterfrage zwei]"),
            ...
            (
                {
                    "code": "numerischeeingabe",
                    "full": _("Numerische Eingabe"),
                    "abbreviated": _("Numerische Eingabe"),
                },
                "N",
                "number",
                "default",
            ...
            (
                {
                    "code": "reisigerfreitext",
                    "full": _("Reisiger Freitext"),
                    "abbreviated": _("Reisiger Freitext"),
                },
                "U",
                "string",
                "default",
            ...
            (
                {
                    "code": "langerfreiertext",
                    "full": _("Langer freier Text"),
                    "abbreviated": _("Langer freier Text"),
                },
                "T",
                "string",
                "default",
            ...
            (
                {
                    "code": "mehrfacherkurztext[SQ001]",
                    "full": _("Mehrfacher Kurztext [Unterfrage eins]"),
            ...
            (
                {
                    "code": "mehrfacherkurztext[SQ002]",
                    "full": _("Mehrfacher Kurztext [Unterfrage zwei]"),
            ...
            (
                {
                    "code": "kurzerfreitext",
                    "full": _("Kurzer Freitext"),
                    "abbreviated": _("Kurzer Freitext"),
                },
                "S",
                "string",
                "default",
            ...
            (
                {
                    "code": "mehrfachauswahl[SQ001]",
                    "full": _("Mehrfachauswahl [Unterfrage eins]"),
            ...
            (
                {
                    "code": "mehrfachauswahl[SQ002]",
                    "full": _("Mehrfachauswahl [Unterfrage zwei]"),
            ...
            (
                {
                    "code": "mehrfachauswahlmitko[SQ001]",
                    "full": _("Mehrfachauswahl mit Kommentaren [Unterfrage eins]"),
                    "abbreviated": _("Mehrfachauswahl..  [Unterfrage eins]"),
                },
                "P",
                "string",
            ...
            (
                {
                    "code": "mehrfachauswahlmitko[SQ001comment]",
                    "full": _("Mehrfachauswahl mit Kommentaren [Comment]"),
            ...
            (
                {
                    "code": "mehrfachauswahlmitko[SQ002]",
                    "full": _("Mehrfachauswahl mit Kommentaren [Unterfrage zwei]"),
                    "abbreviated": _("Mehrfachauswahl..  [Unterfrage zwei]"),
                },
                "P",
                "string",
            ...
            (
                {
                    "code": "mehrfachauswahlmitko[SQ002comment]",
                    "full": _("Mehrfachauswahl mit Kommentaren [Comment]"),
                    "abbreviated": _("Mehrfachauswahl..  [Comment]"),
                },
                "P",
    ...
    def test_reusing_experimental_protocol_in_two_groups_returns_correct_directory_structure(self, mockServer):
        ...
        self.assertFalse(
            any(
                os.path.join(
                    "Group_" + slugify(self.group.title),
                    "Per_participant",
    ...
    def test_participant_age_in_responses_is_age_when_questionnaire_was_filled_2(self, mockServer):
        ...
        with open(os.path.join(temp_dir, input_export.BASE_DIRECTORY, "Participants.csv")) as file:
            ...
            self.assertEqual(
                rows[1][1],
                self.subject_age(self.patient.date_birth, self.questionnaire_response),
            )
...
class ExportDataCollectionTest(ExportTestCase):
    ...
    def test_export_experiment_with_generic_data_colletion(self):
        ...
        self.assert_per_participant_step_file_exists(
            ...
            os.path.basename(gdcf.file.name),
            zipped_file,
        )
        self.assert_per_participant_step_file_exists(
            step_number,
    ...
    def test_export_experiment_with_eeg(self):
        ...
        self.assert_per_participant_step_file_exists(
            ...
            component_step,
            "EEGData_1",
            os.path.basename(eegf.file.name),
            zipped_file,
        )
    ...
    def test_export_experiment_with_emg(self):
        ...
        self.assert_per_participant_step_file_exists(
            ...
            component_step,
            "EMGData_1",
            os.path.basename(emgf.file.name),
            zipped_file,
        )
    ...
    def test_export_experiment_with_tms(self):
        ...
        for path in create_list_of_trees(self.group.experimental_protocol, "tms"):
            tms_conf = ComponentConfiguration.objects.get(pk=path[-1][0])
...
class ExportFrictionlessDataTest(ExportTestCase):
    ...
    def test_export_per_experiment_creates_datapackage_json_file(self):
        ...
        zipped_file = self.get_zipped_file(response)
        self.assertTrue(
            any("datapackage.json" in element for element in zipped_file.namelist()),
    ...
    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_experiment_contributors_to_datapackage_json_file(
        self,
    ):
        self._create_eeg_export_data()
    ...
    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_creative_commons_license_to_datapackage_json_file(
        self,
    ):
        self._create_eeg_export_data()
        self.append_session_variable("group_selected_list", [str(self.group.id)])
    ...
    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_basic_experiment_data_file_info_to_datapackage_json_resources_field(
        self,
    ):
        self._create_eeg_export_data()
        self.append_session_variable("group_selected_list", [str(self.group.id)])
        ...
        test_dict = {
            "name": "Experiment",
            "title": "Experiment",
            "path": "data/Experiment_data/Experiment.csv",
            "format": "csv",
            "mediatype": "text/csv",
            "encoding": "UTF-8",
    ...
    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_experiment_table_schema_info_to_datapackage_json_experiment_resource(
        self,
    ):
        self._create_eeg_export_data()
        self.append_session_variable("group_selected_list", [str(self.group.id)])
    ...
    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_participant_data_file_info_to_datapackage_json_resources_field(
        self,
    ):
        self._create_eeg_export_data()
        self.append_session_variable("group_selected_list", [str(self.group.id)])
        ...
        self.assertEqual(
            ...
            str(test_dict) + " not equal " + str(participants_resource),
        )

        shutil.rmtree(temp_dir)

    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_participants_table_schema_info_to_datapackage_json_participants_resource(
        self,
    ):
        self._create_eeg_export_data()
        self.append_session_variable("group_selected_list", [str(self.group.id)])
    ...
    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_participants_diagnosis_file_info_to_datapackage_json_resources_field(
        self,
    ):
        self._create_eeg_export_data()
        self.append_session_variable("group_selected_list", [str(self.group.id)])
    ...
    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_participants_diagnosis_table_schema_info_to_datapackage_json_participants_resource(
        self,
    ):
        self._create_eeg_export_data()
        self.append_session_variable("group_selected_list", [str(self.group.id)])
    ...
    def test_export_per_experiment_adds_experimental_protocol_image_file(self):
        ...
        protocol_image_resource = {
            ...
            "path": os.path.join(
                "data",
                "Experiment_data",
                "Group_" + slugify(self.group.title).replace("-", "_"),
    ...
    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_tms_data_description_and_hotspot_map_files(
        self,
    ):
        temp_dir = tempfile.mkdtemp()
        self._create_tms_export_data(temp_dir)  # pass temp_dir for hotspot file creation
    ...
    def test_export_per_experiment_adds_generic_data_collection_file(self):
        ...
        gdc_resource = {
            ...
            "path": os.path.join(
                ...
                "Per_participant",
                "Participant_" + self.patient.code,
                "Step_1_GENERIC_DATA_COLLECTION",
                "Generic_Data_Collection_1",
                filename,
            ),
    ...
    def test_export_per_experiment_adds_goalkeeper_game_files(self):
        ...
        digital_game_phase_resource1 = {
            ...
            "path": os.path.join(
                ...
                filename_goalkeeper_game_data_dir + ".csv",
            ),
            "encoding": "UTF-8",
        }
    ...
    @override_settings(MEDIA_ROOT=TEMP_MEDIA_ROOT)
    def test_export_per_experiment_adds_participant_data_collection_additional_file(
        self,
    ):
        self._create_eeg_export_data()
    ...
    def test_export_per_experiment_adds_questionnaire_metadata_file_to_datapackage_json_file(self, mockServer):
        ...
        test_dict = {
            ...
            "path": os.path.join(
                ...
                code + "_" + slugify(self.questionnaire.survey.en_title),
                filename,
            ),
            "format": "csv",
            "mediatype": "text/csv",
    ...
    def test_export_per_experiment_adds_questionnaire_responses_file_to_datapackage_json_file1(self, mockServer):
        ...
        for heading_type in "code", "full", "abbreviated":
            ...
            self.assertEqual(
                ...
                "Failed for heading type "
                + "'"
                + heading_type
                + "'\n"
                + str(test_dict)
                + " not equal "
                + str(questionnaire_response_resource),
            )
    ...
    def test_export_per_experiment_adds_questionnaire_responses_table_schema_info_to_datapackage_json_file1(
        ...
        for heading_type in "code", "full", "abbreviated":
            ...
            for item in questions:
                self.assertIn(
                    {
                        "name": item[0][heading_type],
                        "title": item[0][heading_type],
                        "type": item[2],
                        "format": item[3],
                    },
                ...
                self.assertIn(
                    {
                        "name": title,
                        "title": title,
                        "type": patient_field["json_data_type"],
                        "format": "default",
                    },
                    questionnaire_response_resource["schema"]["fields"],
                )
    ...
    def test_export_per_participant_adds_questionnaire_response_file_to_datapackage_json_file2(self, mockServer):
        ...
        for survey in [survey1, survey2]:
            ...
            path_resource = os.path.join(
                ...
                "Per_participant",
                "Participant_" + self.patient.code,
                survey.code + "_" + slugify(survey.en_title),
                filename + extension,
            )
            questionnaire_response_resource = next(
            ...
            test_dict = {
                ...
                "path": os.path.join(
                    ...
                    "Per_participant",
                    "Participant_" + self.patient.code,
                    str(survey.code) + "_" + slugify(survey.en_title),
                    filename + extension,
                ),
                "format": "csv",
                "mediatype": "text/csv",
