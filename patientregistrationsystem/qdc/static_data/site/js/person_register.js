...
document.addEventListener("DOMContentLoaded", () => {
  ...
  $('input[name = "optradio"]').on("change", function (e) {
    ...
    if (e.currentTarget.value == "1") {
      ...
      if (update_password_div.hasClass("in")) {
        update_password_div.collapse("hide");
      }
      if (password_div.hasClass("in")) {
        password_div.collapse("hide");
      }
      if (id_new_password2_form_group_div.hasClass("in")) {
        id_new_password2_form_group_div.collapse("hide");
      }
      if (profiles_div.hasClass("in")) {
        profiles_div.collapse("hide");
      }
