...
function show_modal_remove(list_name, accordion_position, conf_position) {
  ...
  $("#modalRemoveMessage").text(gettext("Are you sure you want to delete this use of step from list?"));
...
function show_modal_remove_many(list_name, accordion_position, length) {
  ...
  $("#modalRemoveMessage").text(
    gettext("Are you sure you want to delete these ") + length + gettext("  uses of step from list?")
  );
