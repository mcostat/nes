...
ready(function () {
  var id_number_of_mandatory_components = $(
    "#id_number_of_mandatory_components"
  );
  ...
  function fix_bootstrap_error_message() {
    setTimeout(function () {
      ...
      $("#div_for_errors_in_number_of_mandatory_components")
        .children("ul")
        .remove();
  ...
  function expand() {
    ...
    $(this)
      ...
      .switchClass("fa-chevron-right", "fa-chevron-down");
    ...
    $(this)
      ...
      .attr("data-original-title", gettext("Collapse"));
  }
  ...
  function collapse() {
    ...
    $(this)
      ...
      .switchClass("fa-chevron-down", "fa-chevron-right");
    ...
    $(this)
      .children(".panel-heading")
      .attr("data-original-title", gettext("Expand"));
  }
...
function show_modal_remove(list_name, accordion_position, conf_position) {
  ...
  modal_remove.setAttribute(
    "value",
    "remove-" + list_name + "-" + accordion_position + "-" + conf_position
  );

  $("#modalRemoveMessage").html(
    gettext("Are you sure you want to delete this use of step from list?")
  );
...
function show_modal_remove_many(list_name, accordion_position, length) {
  ...
  modal_remove.setAttribute(
    "value",
    "remove-" + list_name + "-" + accordion_position
  );

  $("#modalRemoveMessage").html(
    gettext("Are you sure you want to delete these ") +
      length +
      gettext("  uses of step from list?")
  );
