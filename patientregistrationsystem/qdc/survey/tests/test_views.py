...
class ABCSearchEngineTest(TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            questions_id = lime_survey.insert_questions(self.test_sid, questions_data, "lsg")
            ...
            token = lime_survey.get_participant_properties(self.test_sid, result_token, "token")
...
class SurveyTest(TestCase):
    ...
    @patch("survey.abc_search_engine.Server")
    def test_update_acquisitiondate_from_limesurvey_with_date_in_wrong_format_fails_silently(self, mockServer):
        self._set_mocks(mockServer)
    ...
    @patch("survey.abc_search_engine.Server")
    def test_GET_update_survey_acquisitiondate_view_redirects_to_survey_view(self, mockServer):
        self._set_mocks(mockServer)
    ...
    @patch("survey.abc_search_engine.Server")
    def test_update_acquisitiondate_from_limesurvey_returns_responses_updated1(self, mockServer):
        ...
        ls_responses = b64decode(mockServer.return_value.export_responses.return_value).decode()
    ...
    @patch("survey.abc_search_engine.Server")
    def test_update_acquisitiondate_from_limesurvey_returns_responses_updated2(self, mockServer):
    ...
    @patch("survey.abc_search_engine.Server")
    def test_GET_update_survey_acquisitiondate_view_redirects_to_survey_view_with_right_message1(self, mockServer):
        """No responses were updated"""
    ...
    @patch("survey.abc_search_engine.Server")
    def test_GET_update_survey_acquisitiondate_view_redirects_to_survey_view_with_right_message2(self, mockServer):
    ...
    def _set_mocks(mockServer):
        ...
        mockServer.return_value.get_participant_properties.return_value = {"completed": "2020-09-25 09:19"}
        mockServer.return_value.get_language_properties.return_value = {"surveyls_title": "Survey title"}
