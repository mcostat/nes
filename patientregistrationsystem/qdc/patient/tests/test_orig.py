...
class UtilTests:
    ...
    def create_cid10(code=None) -> ClassificationOfDiseases:
        ...
        return ClassificationOfDiseases.objects.create(
            ...
            abbreviated_description=fake.sentence(nb_words=6),
        )
...
class PatientFormValidation(TestCase):
    ...
    def test_smoker_patient_can_not_be_ex_smoker(self):
        ...
        response = self.client.post(
            reverse("patient_edit", args=(patient_to_update.pk,)),
            self.data,
            follow=True,
        )
        self.assertEqual(Patient.objects.filter(name=name).count(), 1)
...
class MedicalRecordFormValidation(TestCase):
    ...
    def test_diagnosis_create_and_delete(self):
        ...
        response = diagnosis_create(
            ...
            medical_record_id=medical_record.pk,
            cid10_id=cid10.pk,
        )
        self.assertEqual(response.status_code, 302)
        self.assertEqual(
    ...
    def test_medical_record_crud(self):
        ...
        request = self.factory.get(
            reverse(
                "medical_record_diagnosis_create",
                args=[
                    patient.pk,
                    cid10.pk,
                ],
    ...
    def test_exam_create(self):
        ...
        response = exam_create(
            request,
            patient_id=patient.pk,
            record_id=medical_record.pk,
...
class QuestionnaireFormValidation(TestCase):
    ...
    def _set_mocks(mockServer):
        ...
        mockServer.return_value.list_questions.side_effect = [
            [
                {
                    "question": "Presença de freezing?",
                    "parent_qid": 0,
                    "qid": 59414,
                    "modulename": "",
                    "mandatory": "Y",
                    "id": {"language": "pt-BR", "qid": 59414},
                    "title": "ynFreezingLeft",
                    "gid": 2617,
                    "scale_id": 0,
                    "same_default": 0,
                    "type": "Y",
                ...
                },
                {
                    ...
                    "modulename": "",
                    "mandatory": "Y",
                    "id": {"language": "pt-BR", "qid": 59413},
                    "title": "ynFreezingRight",
                    "gid": 2617,
                    "scale_id": 0,
                    "same_default": 0,
                    "type": "Y",
        ...
        mockServer.return_value.export_responses_by_token.return_value = ""
    ...
    def test_entrance_evaluation_response_view(self, mockServer):
        ...
        self.assertEqual(
            response.context["patient_questionnaires_data_list"][0]["survey_id"],
            survey.pk,
        )
        self.assertEqual(
    ...
    def test_entrance_evaluation_response_update(self, mockServer):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
            response_survey.token_id,
            response.context["questionnaire_response"].token_id,
        )
