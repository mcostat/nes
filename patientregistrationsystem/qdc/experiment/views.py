...
from .forms import (ADConverterRegisterForm, AdditionalDataForm,
                    ...
                    StimuliDataForm, StimuliEqRegisterForm,
                    StimuliEqSettingForm, StimulusForm, SubjectStepDataForm,
...
from .models import (EEG, EMG, TMS, ADConverter, AdditionalData,
                     ...
                     StandardizationSystem, StimuliData, StimuliEq,
                     StimuliEqSetting, Stimulus, Subject, SubjectOfGroup,
                     SubjectStepData, Tag, Task, TaskForTheExperimenter,
                     TMSData, TMSDevice, TMSDeviceSetting,
...
@permission_required("experiment.register_equipment")
def stimuli_eq_list(
    request, template_name="experiment/stimuli_eq_list.html"
) -> HttpResponse:
