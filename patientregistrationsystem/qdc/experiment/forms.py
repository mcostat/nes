...
from django.forms import (CheckboxInput, ClearableFileInput, Form,
                          IntegerField, ModelChoiceField, ModelForm,
                          NumberInput, RadioSelect, Select, Textarea,
                          TextInput, TimeInput, TypedChoiceField, URLInput,
                          ValidationError)
from django.shortcuts import get_object_or_404
from django.utils.encoding import smart_str
from django.utils.translation import gettext as _

from experiment.models import (EEG, EMG, TIME_UNITS, TMS, ADConverter,
                               AdditionalData, Amplifier, Block, CoilModel,
                               CoilOrientation, Component,
                               ...
                               EEGElectrodeCap, EEGElectrodeLocalizationSystem,
                               EEGElectrodeNet, EEGElectrodePosition,
                               ...
                               FileFormat, FilterType, GenericDataCollection,
                               GenericDataCollectionData, Group, HotSpot,
                               Instruction, Manufacturer, Material,
                               MediaCollection, MediaCollectionData, Muscle,
                               MuscleSide, MuscleSubdivision, Publication,
                               QuestionnaireResponse, ResearchProject,
                               ScheduleOfSending, Software, SoftwareVersion,
                               SourceCode, StandardizationSystem, StimuliData,
                               StimuliEq, StimuliEqSetting, Stimulus,
                               SubjectOfGroup, SubjectStepData, TMSData,
