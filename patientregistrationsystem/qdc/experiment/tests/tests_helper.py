...
from experiment.models import (EEG, EMG, TMS, ADConverter, AdditionalData,
                               AdditionalDataFile, Amplifier, Block, BrainArea,
                               BrainAreaSystem, CoilModel, CoilOrientation,
                               CoilShape, Component, ComponentConfiguration,
                               ContextTree, DataConfigurationTree,
                               ...
                               EEGSetting, EEGSolution, ElectrodeModel,
                               EMGData, EMGElectrodePlacement,
                               EMGElectrodePlacementSetting,
                               EMGElectrodeSetting, EMGFile, EMGSetting,
                               Experiment, ExperimentResearcher, FileFormat,
                               FilterType, GenericDataCollection,
                               GenericDataCollectionData,
                               GenericDataCollectionFile, Group,
                               InformationType, Manufacturer, Material, Muscle,
