...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("experiment", "0006_alter_manufacturer_name"),
    ]

    operations = [
        migrations.AddField(
            model_name="stimulus",
            name="stimuli_setting",
        ...
        migrations.CreateModel(
            ...
            options={
                "verbose_name": "historical stimuli data",
                "verbose_name_plural": "historical stimuli datas",
