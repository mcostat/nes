...
class PluginTest(ExportTestCase):
    ...
    def _create_basic_objects(self):
        ...
        UtilTests.create_response_survey(self.user, self.patient, self.survey3, 21)
    ...
    def test_root_url_resolves_send_to_plugin_view(self):
        view = resolve("/plugin/")
        self.assertEqual(view.func, send_to_plugin)
    ...
    def test_does_not_define_admission_questionnaire_attribute_does_not_display_plugin_entry_in_menu(
        ...
        self.assertNotIn("Plugin", response.content.decode("utf-8"), "Plugin appears")

    def test_does_not_define_surgical_questionnaire_attribute_does_not_display_plugin_entry_in_menu(
        self,
    ):
        self._create_basic_objects()
    ...
    def test_does_not_define_followup_questionnaire_attribute_does_not_display_plugin_entry_in_menu(
        self,
    ):
        self._create_basic_objects()
    ...
    def test_does_not_define_plugin_url_attribute_does_not_display_plugin_entry_in_menu(
        self,
    ):
        self._create_basic_objects()
