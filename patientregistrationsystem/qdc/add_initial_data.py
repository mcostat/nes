...
PermissionTable = [
    ...
    _("Can view medical record data"),
    _("Can view patient"),
    _("Can view questionnaire response"),
    _("Can view questionnaire response"),
    _("Can view research project"),
    _("Can view survey"),
    _("Can export medical record data"),
...
junior_researcher_permission_list += [
    ...
    Permission.objects.get(codename="can_send_data_to_plugin", content_type=plugin_content_type),
]
...
senior_researcher_permission_list += [
    Permission.objects.get(
        codename="change_researchproject_from_others",
    ...
    Permission.objects.get(
        codename="export_questionnaireresponse",
        content_type=patient_quest_response_content_type,
    ),
...
administrator_permission_list += [
    ...
    Permission.objects.get(
        codename="change_researchproject_owner",
        content_type=researchproject_content_type,
    ),
    Permission.objects.get(codename="add_medicalrecorddata", content_type=medicalrecorddata_content_type),
]
